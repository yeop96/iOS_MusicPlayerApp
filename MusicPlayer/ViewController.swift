...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.addViewsWithCode() //코드로 작성한 뷰
        self.initializePlayer()
    }
    
    func initializePlayer(){
        guard let soundAsset: NSDataAsset = NSDataAsset(name: "numbers_sound") else{
    ...
    func addPlayPauseButton() {
        ...
        button.setImage(UIImage(named: "PinkCat"), for: UIControl.State.normal)
        button.setImage(UIImage(named: "catImage"), for: UIControl.State.selected)
